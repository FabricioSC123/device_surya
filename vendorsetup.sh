...
#Fix Kernel storm
git -C kernel/xiaomi/surya revert e28dfd2aaba38e0883b6fcf37231ee14e244c54d -n -e
git -C kernel/xiaomi/surya revert 4988721bb60be00e7046de1264334acc3cf9dd17 -n -e 
git -C kernel/xiaomi/surya revert 3a7a861f01bf47dc6162b810dad48b8895ec85e0 -n -e
git -C kernel/xiaomi/surya revert 8e8475087a44da20c1078afbd8fc9878e373a9dc -n -e 
git -C kernel/xiaomi/surya revert 81b34dcd608eaef73530d73406ace8997226e2c6 -n -e 
git -C kernel/xiaomi/surya revert 373a85e58fcf3966a5751ce3f6bf1215e013c6de -n -e 
git -C kernel/xiaomi/surya revert 7614a711f798a7517f1ff60546fcbb700873f7f6 -n -e
#fix changue kernel
git -C kernel/xiaomi/surya revert 928212482106338cfd5ad43e9f02d648ba0d0df1 -n -e
